...
Primeiramente vamos definir o resíduo como:
\begin{equation}
...
Como primeiro passo vamos tentar remover o espalhamento utilizando a regressão linear representada
...
Como finalização desta seção vamos 
