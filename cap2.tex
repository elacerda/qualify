...
Como veremos mais adiante (Sec.\ \ref{sec:synvsneb:tauv}, Fig.\ \ref{fig:HistoRadProfProps} - {\em
...
Integrando \eqref{eq:dLambda} dentro do tempo do Universo ($T_U\ \sim$ 14 bilhões de anos) teremos
