...
Todos os demais elementos, além do hidrogênio e do hélio, são considerados metais em astrofísica.
...
muito em função da temperatura e da densidade nas regiões $\mathrm{H}_2$. Portanto:
\begin{equation}
