...
\begin{figure}
	\centering
	\resizebox{0.99\textwidth}{!}{\includegraphics{figuras/histoTauVR.pdf}}
...
\begin{figure}
	\centering
	\resizebox{0.99\textwidth}{!}{\includegraphics{figuras/DtauR.pdf}}
...
\begin{figure}
	\centering
	\resizebox{0.99\textwidth}{!}{\includegraphics{figuras/RtauR.pdf}}
...
alterar no mesmo passo que a inclinação se altera. Na Fig. \ref{fig:model} \myojo{blue}{(fazer
figura)} fica melhor explicado.
...
\begin{figure}
	\centering
	\resizebox{0.99\textwidth}{!}{\includegraphics{figuras/tauISMBC_R.pdf}}
