...
diferentes fenônmenos astrofísicos \myojo{blue}{(lista de diferentes projetos com referencias\ldots
SDSS, CALIFA, EDGE, JPAS, ALFALFA, PINGs, HERACLES, WISE, GALEX, 2dF\ldots)}. Além de estarem
...
\begin{equation}
	\label{eq:dust2gas}
	\SigmaGas\ =\ \deltaDGR \Sigma_{\mathrm{dust}}, 
\end{equation}
\noinden onde $\deltaDGR$ é a razão entre poeira e gás ({\em dust-to-gas ratio} - DGR) e
